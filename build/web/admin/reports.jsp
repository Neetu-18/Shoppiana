    ...
    <body>
        ...
        <div id="container">
                ...
                <div class="shell">
                    ...
                    <div id="navigation">
                        <ul>
                            ...
                            <li><a href="reports.jsp" class="active"><span>Reports</span></a></li>
            ...
            <div id="content" class="shell">
                ...
                <!-- Help Navigation -->
                <div id="help-nav">
                    <a href="index.jsp">Dashboard</a> &gt; All Reports
                </div>
                <!-- End Help Navigation -->
                ...
                <div class="user_details">
                    ...
                    <%
                        ...
                        ResultSet resultset1 = statement.executeQuery("select count(*) from orders");
                        while (resultset1.next()) {
                            count = resultset1.getInt("count(*)");
                    %>
                    <h1>Total Reports (<% out.print(count);%>)</h1>
                    <% }%>
                    ...
                    <table  border="0" cellspacing=0 cellpadding=10 class="tab2" style="width: 100%;">
                        ...
                        <tr style="background: none repeat scroll 0% 0% #ECF8FD;font-size:13px;">
                            ...
                            <th><%out.print(resultset.getDate(2));%></th>
                            <td><%out.print(resultset.getInt(3));%></td>
                            <td><%out.print(resultset.getInt(4));%></td>
                            <td><%out.print(resultset.getFloat(5));%></td>
