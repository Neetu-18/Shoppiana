    ...
    <body>
        ...
        <div id="container">
                ...
                <div class="shell">
                    ...
                    <div id="navigation">
                        <ul>
                            ...
                            <li><a href="orders.jsp" class="active"><span>Orders</span></a></li>
            ...
            <div id="content" class="shell">
                ...
                <!-- Help Navigation -->
                <div id="help-nav">
                    <a href="index.jsp">Dashboard</a> &gt; All Orders
                </div>
                <!-- End Help Navigation -->
                ...
                <div class="user_details">
                    ...
                    %>
                    <h1>Total Orders (<% out.print(count);%>)</h1>
                    <% }%>
                    ...
                    <table  border="0" cellspacing=0 cellpadding=10 class="tab2" style="width: 100%;">
                        ...
                        <tr style="background: none repeat scroll 0% 0% #ECF8FD;font-size:13px;">
                            ...
                            <td><%out.print(resultset.getDate(2));%></td>
