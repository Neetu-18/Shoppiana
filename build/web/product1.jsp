<%-- 
    Document   : product1
    Created on : Sep 22, 2018, 10:49:34 AM
    Author     : rohitkumar
--%>
...
<!-- All Product Category --> 
 <% if((item=request.getParameter("All"))!=null) {
    %>   
  <div class="product-sec1">                    
<% 
  if((allProduct=prod.AllProduct(item)).isEmpty()==false)
{
...
<% if((search=request.getParameter("Search"))!=null) {%>                                          
 <div class="product-sec1">
 <%     
if((allProduct=prod.searchprod(search)).isEmpty()==false)
{
while(i<allProduct.size()){ 
    prodbean=(prod_bean)allProduct.get(i);
%>    
...
<%}%>
 ...
 <!-- Product price range and rating wise --> 
<% if((rating=request.getParameter("rating"))!=null) {
...
%>                                          
 <div class="product-sec1">
 <%     
if((allProduct=prod.Prod_rating(min,max,rating)).isEmpty()==false)
{
while(i<allProduct.size()){ 
    prodbean=(prod_bean)allProduct.get(i);
%>    
