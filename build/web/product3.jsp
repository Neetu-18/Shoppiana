...
<html>
    <head>
        <title>Shoppiana| Personal Care Products </title>
        <!--/tags -->
    ...
    <body>
        ...
        <div class="ads-grid">
            <div class="container">
                <!-- tittle heading -->
                <h3 class="tittle-w3l">Personal Care Products
...
<% 
String item=request.getParameter("var");

      int j;
  if((allProduct=prod.ProductCat("Personal Care", item)).isEmpty()==false)
{
