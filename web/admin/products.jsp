...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="content" class="shell">
                ...
                <!-- Help Navigation -->
                <div id="help-nav">
                    <a href="index.jsp">Dashboard</a> &gt; All Products
                </div>
                <!-- End Help Navigation -->
   ...
   <!-- Product Category -->
                <div class="user_details">
                    <%
                        ResultSet resultset2 = statement.executeQuery("select count(*) from p_category");
                        while (resultset2.next()) {
                            count = resultset2.getInt("count(*)");
                    %>
                    <h1>Products Category (<% out.print(count);%>)</h1>
                    <% }%>
                    <h1 style="float:right;"><a href="p_category.jsp?add=1" id="show">Add New Category</a></h1>
                    ...
                    <table  border="0" cellspacing=0 cellpadding=10 class="tab2" style="width: 100%;">
                        <tr style="background-color: #60C8F2;">
                            ...
                            <%
                                ResultSet resultset3 = statement.executeQuery("select * from p_category");
                                while (resultset3.next()) {
                                    i++;
                            %>
                            <tr style="background: none repeat scroll 0% 0% #ECF8FD;font-size:13px;">
                            <td><% out.print(i);%></td>
                            <td><%out.print(resultset3.getInt(1));%></td>
                            <th><%out.print(resultset3.getString(2));%></th>
                            <td><%out.print(resultset3.getString(3));%></td>
                           
                            <td><a href="p_category.jsp?edit=<%out.print(resultset3.getInt(1));%>"><img src="images/user_edit.png"></a></td>
                            <td><a href="#" id="myBtn"><img src="images/trash.png"></a></td>
                        </tr>
                        <%  } i=0; %>
                    </table>
                </div><hr><br>
...
<div class="user_details">
    ...
    %>
    <h1>Total Products (<% out.print(count);%>)</h1>
    <% }%>
    ...
    <table  border="0" cellspacing=0 cellpadding=10 class="tab2" style="width: 100%;">
        ...
        <tr style="background: none repeat scroll 0% 0% #ECF8FD;font-size:13px;">
            ...
            <td><%out.print(resultset.getFloat(4));%></td>
            <td><%out.print(resultset.getString(5));%></td>
            <td><%out.print(resultset.getString(7));%></td>
            <td><img src='../Retriveimage?<%= resultset.getInt(1)%>' alt='' height="30" width="30"/></td>
            <td><a href="edit_product.jsp?pid=<%out.print(resultset.getInt(1));%>"><img src="images/user_edit.png"></a></td>
            <td><a href="#" id="myBtn"><img src="images/trash.png"></a></td>
        </tr>
        <%  } %>
    </table>
...
<!-- Total  Product -->     
            ...
            <div id="myModal" class="modal">
                <form name="popup" class="modal-content" action="../ProductUpdate?m3=321" method="post">
                    <span class="close">&times;</span>
                    <h1>Are You Sure Want to Delete?</h1>
                    <input type="hidden" name="p_id" value="<% out.print(res2.getInt(1));%>">
                    <a href="#" id="closed" >No</a>
