    ...
    <body>
        <div id="container">
                ...
                <div class="shell">
                    ...
                    <div id="navigation">
                        <ul>
                            ...
                            <li><a href="customers.jsp" class="active"><span>Customers</span></a></li>
            ...
            <div id="content" class="shell">
                ...
                <!-- Help Navigation -->
                <div id="help-nav">
                    <a href="index.jsp">Dashboard</a> &gt; All Customers
                </div>
                <!-- End Help Navigation -->
                ...
                <div class="user_details">
                    ...
                    <%
                        ...
                        ResultSet resultset1 = statement.executeQuery("select count(*) from customer");
                        while (resultset1.next()) {
                            count = resultset1.getInt("count(*)");
                    %>
                    <h1>Total Customers (<% out.print(count);%>)</h1>
                    <% }%>
